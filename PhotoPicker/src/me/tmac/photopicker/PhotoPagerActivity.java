...
import static me.tmac.photopicker.PhotoPreview.EXTRA_CURRENT_ITEM;
import static me.tmac.photopicker.PhotoPreview.EXTRA_PHOTOS;
import static me.tmac.photopicker.PhotoPreview.EXTRA_SHOW_DELETE;
...
public class PhotoPagerActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    pagerFragment.getViewPager().setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
